      ...
      return (
        <div>
            <Nav fill justify variant="tabs" >
                <Nav.Item>
                    <Button onClick={this.handleClick} value="open" variant="outline-dark" style={{flexDirection:"row" , width:"100%"}}>
                        <b>Open</b>
                    </Button>
                </Nav.Item>
                <Nav.Item>
                    <Button onClick={this.handleClick} value="women" variant="outline-dark" style={{flexDirection:"row" , width:"100%"}}>
                        <b>Women</b>
                    </Button>
                </Nav.Item>
            </Nav>

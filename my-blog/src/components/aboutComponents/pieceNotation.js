            ...
            <Navbar variant="dark" bg="dark" expand="lg">
                <Container fluid>
                    ...
                    <Nav>
                        ...
                        menuvariant="dark"
                        >
                            <NavDropdown.Item  onSelect={ ()=>setSymbol( piece[0] ) }>King</NavDropdown.Item>
                            <NavDropdown.Item  onSelect={ ()=>setSymbol( piece[1] ) }>Queen</NavDropdown.Item>
                            <NavDropdown.Item  onSelect={ ()=>setSymbol( piece[2] ) }>Rook</NavDropdown.Item>
                            <NavDropdown.Item  onSelect={ ()=>setSymbol( piece[3] ) }>Knight</NavDropdown.Item>
                            <NavDropdown.Item  onSelect={ ()=>setSymbol( piece[4] ) }>Bishop</NavDropdown.Item>
                            <NavDropdown.Item  onSelect={ ()=>setSymbol( piece[5] ) }>Pawn</NavDropdown.Item>
                        </NavDropdown>
                    </Nav>
                    </Navbar.Collapse>
                </Container>
            ...
            <div style={{border:'1px solid black'}} className="my-4">
                <Row style={{padding:'5%',textAlign:'center'}}>
                    <Col style={{fontSize:'200%'}}>
                        <Alert variant="dark">
                            <img style={{height:'50%',width:'50%'}} src={symbol.imgpath} alt='piece symbol'/>
                            {symbol.name}
                        </Alert>
                    </Col>
                    <Col style={{fontSize:'510%'}}><Alert variant="dark">{symbol.notation}</Alert></Col>
                    <Col style={{fontSize:'510%'}}><Alert variant="dark">{symbol.value}</Alert></Col>
                </Row>
                <Row style={{textAlign:'center', fontSize:'150%'}} className='my-3'>
                    <Col>Icon</Col>
                    <Col>Symbol</Col>
                    <Col>Value</Col>
                </Row>

        ...
        <>
            ...
            <Alert variant={'dark'}>
                <div>
                    <Row>
                        <Col>
                            <RatingCardComponent image={racerImage} run={props.racerrun} score={props.racerscore} />
                        </Col>
                        <Col>
                            <RatingCardComponent image={stormImage} run={props.stormrun} score={props.stormscore} />
                        </Col>
                    </Row>
                    <Row>
